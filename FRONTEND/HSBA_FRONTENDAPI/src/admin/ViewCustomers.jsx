...
export default function ViewCustomers() 
{
    ...
    const displayCustomers = async () => 
    {
        try
        {
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/admin/viewallcustomers`);
    ...
    const deleteCustomer = async (cid) => 
    {
        try
        {
            const response = await axios.delete(`${import.meta.env.VITE_API_URL}/admin/deletecustomer?cid=${cid}`);
