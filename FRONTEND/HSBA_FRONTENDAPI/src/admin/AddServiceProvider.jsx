...
export default function AddServiceProvider()
{
  ...
  const handleSubmit = async (e) => 
  {
    ...
    try
    {
        const response = await axios.post(`${import.meta.env.VITE_API_URL}/admin/addserviceprovider`, formData);
  ...
  return (
    <div>
      <h3 style={{ textAlign: "center",textDecoration: "underline"}}>Add Service Provider</h3>
      {
            message?
